    ...
    App.Views.FlatPreview = Backbone.View.extend({
        ...
        panorama: function(){
			...
			PosMarker.prototype.markerClickHandler = function(e) {
			  ...
			  alert($(this).data("info") + " is sitting there!");
			...
			PosMarker.create = function(index, x, y, z, personObj) {
			  var element = document.createElement('div');
			  $(element).attr('data-info', personObj.name);
			...
			Panorama.prototype = {
			  ...
			  placeMarkers: function() {
			    var i;
			    for ( i = 0; i < this.markerLen; ++i) {
			      self.$("#container")[0].appendChild(this.markers[i]);
			      this.markers[i].activate();
			    }
			    for (i = 0; i < this.navMarkers.length; ++i) {
			      self.$("#container")[0].appendChild(this.navMarkers[i]);
			  ...
			  removeMarkers: function() {
			    for (var i = 0; i < this.markerLen; ++i) {
			      $('#container')[0].removeChild(this.markers[i]);
			      this.markers[i].deactivate();
			    }
			    for (i = 0; i < this.navMarkers.length; ++i) {
			      $('#container')[0].removeChild(this.navMarkers[i]);
